...
public class AddStudent extends JFrame implements ActionListener{
	...
	add(Image);
            ...
            //Roll NUMBER
            JLabel rollNumber = new JLabel("Student Id: ");
...
//AddStudent -> String q = "INSERT INTO `Studentdetails`(`Name`,`FatherName`,`MotherName`,`StudentId`,`DateOfBirth`,`Phone`,`psc`,`Jsc`,`Ssc`, `Department`, `Admission`) VALUES ('"+name+"','"+fname+"','"+mname+"','"+rollno+"','"+Dob+"','"+adress+"','"+phone+"','"+email+"','"+PSC+"','"+JSC+"','"+SSc+"','"+Department+"','"+AdmissionDate+"')";             
